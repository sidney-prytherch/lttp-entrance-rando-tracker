...
export const load: PageLoad = ({ params }) => {
	let regions: {
		...
		'Flute Drop - Desert': {
			...
			fullyAccessible: [],
			connectsToRegionWithReq: { "Desert Warp Ledge": [[]] },
			coords: [31, 2012],
			exitToRegionButCantEnterWithoutReq: {}
		},
		...
		'Desert Warp Ledge': {
			...
			fullyAccessible: [],
			connectsToRegionWithReq: { "Light World": [[]], 'Warp Tile - Desert': [["progressive glove~2"]] },
			coords: [],
			exitToRegionButCantEnterWithoutReq: {}
		},
		'Warp Tile - Desert': {
		...
		'Light World': {
			...
			"connectsToRegionWithReq": {
				...
				'Flute Drop - Death Mountain': [["flute"]],
				'Flute Drop - Potion Shop': [["flute"]],
				'Flute Drop - Kakariko': [["flute"]],
				'Flute Drop - Links House': [["flute"]],
				'Flute Drop - East Region': [["flute"]],
				'Flute Drop - Desert': [["flute"]],
				'Flute Drop - Dam Region': [["flute"]],
				'Flute Drop - Lake Hylia': [["flute"]],
		...
		'Dark World South': {
			...
			"connectsToRegionWithReq": { "Dark World North West": [["progressive glove~2"]], "Dark Lake Hylia Ledge": [["moon pearl", "flippers"]], "Dark World East": [["moon pearl", "flippers"], ["moon pearl", "magic hammer"]], "Cave 45 Region": [["mirror"]], "Two Brothers House (West) Region": [["mirror", "progressive glove~2", "moon pearl"]], "Light World": [["mirror"]] }
		},
		'Swamp': {
			isInLightWorld: false,
			"regionName": "Swamp",
	...
	let entranceToRegionMap: {
		...
		'Lost Woods Gamble': 'Light World',
		'Lumberjack Tree Cave': 'Light World',
		'Lumberjack House': 'Light World',
		'Potion Shop': 'Light World',
		'Lost Woods Hideout Stump': 'Light World',
		'Lost Woods Hideout Drop': 'Light World',
		'Fortune Teller (Light)': 'Light World',
		'Sanctuary': 'Light World',
		'North Fairy Cave Drop': 'Light World',
		'North Fairy Cave': 'Light World',
		'Kakariko Shop': 'Light World',
		'Tavern (Front)': 'Light World',
		'Light World Bomb Hut': 'Light World',
		'Kakariko Well Drop': 'Light World',
		'Kakariko Well Cave': 'Light World',
		'Blinds Hideout': 'Light World',
		'Elder House (West)': 'Light World',
		'Elder House (East)': 'Light World',
		'Snitch Lady (West)': 'Light World',
		'Snitch Lady (East)': 'Light World',
		'Chicken House': 'Light World',
		'Sick Kids House': 'Light World',
		'Bush Covered House': 'Light World',
		'Tavern North': 'Light World',
		'Blacksmiths Hut': 'Light World',
		'Bat Cave Cave': 'Light World',
		'Library': 'Light World',
		'Kakariko Gamble Game': 'Light World',
		'Two Brothers House (East)': 'Light World',
		'Aginahs Cave': 'Light World',
		'Desert Fairy': 'Light World',
		'Dam': 'Light World',
		'Links House': 'Light World',
		'Lake Hylia Fortune Teller': 'Light World',
		'Cave Shop (Lake Hylia)': 'Light World',
		'Good Bee Cave': 'Light World',
		'Long Fairy Cave': 'Light World',
		'Sahasrahlas Hut': 'Light World',
		'Eastern Palace': 'Light World',
		'Lake Hylia Fairy': 'Light World',
		'Hyrule Castle Secret Entrance Drop': 'Light World',
		'Hyrule Castle Secret Entrance Stairs': 'Light World',
		'Hyrule Castle Entrance (South)': 'Light World',
		'Bonk Rock Cave': 'Light World',
		'Light Hype Fairy': 'Light World',
		'Bonk Fairy (Light)': 'Light World',
		'Mini Moldorm Cave': 'Light World',
		'Ice Rod Cave': 'Light World',
		'20 Rupee Cave': 'Light World',
		'Sanctuary Grave': 'Light World',
		'Bat Cave Drop': 'Light World',
		'50 Rupee Cave': 'Light World',
		'Lumberjack Tree Tree': 'Light World',
